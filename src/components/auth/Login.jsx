  ...
  return (
    <div className="mx-auto w-full max-w-sm lg:w-96">
      ...
      <div className="mt-8 relative">
        ...
        <div className="flex whitespace-nowrap items-center justify-center text-sm text-[#6C7278)] font-normal mt-6 leading-6  plus-jakra-font-normal absolute -bottom-44 left-0 right-0">
